...
export const AboutComponent = () => {
  return (
    <section className="about">
      ...
      <p className="about__text"><span className="about__text--highlighted">iwi® matches people</span> based on their personality types.<br />
        Users are profiled by filling in a fun <span className="about__text--highlighted">Big Five</span> psychological<br /> questionnaire — the only test unanimously<br />accepted by the scientific community.
      </p>
