      ...
      <div className="container">
        <div className="row">
          <div className="col">
            ...
            <p className="about__text"><span className="about__text--highlighted">iwi® matches people</span> based on their personality types.
              Users are profiled by filling in a fun <span className="about__text--highlighted">Big Five</span> psychological questionnaire — the only test unanimously accepted by the scientific community.
            </p>
